...
//   const visibleSchools = schoolSearchQuery.debouncedKeyword.length >= 1 ? schoolSearchQuery.schools : schoolsQuery.data?.schools ?? []
...
//     }
//   }, [mySchool?.id, selectedSchoolId, setSelectedSchoolId, visibleSchools])
